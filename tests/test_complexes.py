...
class TestComplexes:
    ...
    def test_complex_results(self):
        ...
        assert set(complexes) == set([e.to_string() for e in pli_obj.entries])

        assert exists(ifp_file), f"File '{ifp_file}' was not found."
        ...
        assert expected_output == n_atm_grps
        ...
        assert expected_output == n_interactionss
